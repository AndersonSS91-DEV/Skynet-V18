...
# ============================================================
# BLOCO 07.1 — LOOP PRINCIPAL (RECONSTRUÇÃO)
# ============================================================
...
# ============================================================
# BLOCO 07.6 — FINALIZAÇÃO DA BASE_ML
# ============================================================

BASE_ML = pd.DataFrame(lista_resultados)

print("\n" + "=" * 80)
print("BASE_ML GERADA")
print("=" * 80)
...
if "League" in BASE_ML.columns:

    BASE_ML = BASE_ML.sort_values(
