# =========================================
# STREAMLIT — POISSON ENGINE (V9 / V12)
# =========================================
...
# CONFIG
# =========================================
st.set_page_config(page_title="Poisson Engine ⚽", layout="wide")
st.title("⚽ Poisson Skynet — Jogo a Jogo")

# =========================================
# UPLOAD
# =========================================
arquivo = st.file_uploader("📤 Envie o Excel do Poisson", type=["xlsx"])

if arquivo is None:
    st.info("⬆️ Envie o arquivo do dia")
    st.stop()
